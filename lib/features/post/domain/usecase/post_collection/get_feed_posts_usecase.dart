...
class GetFeedPostUseCase
    extends UseCaseWithParam<FutureResult<List<String>>, GetFeedPostParam> {
  ...
  @override
  FutureResult<List<String>> call(GetFeedPostParam param) async {
    var session = await _sessionRepo.getUid();
    var result = await session.fold<FutureResult<List<String>>>(
      (uId) async => await _postCollectionRepo.feedPosts(uId),
